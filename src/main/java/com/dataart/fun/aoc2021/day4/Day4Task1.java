...
@Service
public class Day4Task1 implements Solver, WithLogger {
	...
	private Board readBoard(BufferedReader br) throws IOException {
		var board = new Board(new int[5][5]);
		for (int i = 0; i < 5; i++) {
